...
>
	...
	.closebtn {
      ...
      margin-left: 50px;
			...
			<div class="settings-toggle toggle-settings" onclick="this.parentElement.classList.toggle('open');">
			...
			<xsl:if test="$session:debug='true'">
				...
				<div class="settings-toggle toggle-settings" onclick="xo.stores.seed.sources.reload()">
								...
								<div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden;">
									<div class="simplebar-content" style="padding: 0px;">
										<!--<div class="settings-title">
											<a href="javascript:void(0)" class="closebtn" onclick="this.parentElement.classList.toggle('open');">&#215;</a>
											<h4>Herramientas</h4>
										...
										<!--<div class="settings-section">
											...
											<div class="list-group">
												...
												<button type="button" class="list-group-item list-group-item-action" onclick="xover.sources.reload(); /*window.location.reload(true);*/">Actualizar librerías</button>
												<xsl:if test="$js:cache_name!=''">
